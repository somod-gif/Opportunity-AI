...
import { Bot, Mail, Lock, ArrowRight, Eye, EyeOff, Loader2 } from "lucide-react";
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">Sign in to continue your missions</p>
          </div>
          ...
          <div className="mt-6 space-y-3 text-center text-sm">
            <Link href="/forgot-password" className="text-muted-foreground/70 hover:text-primary transition-colors">
              Forgot password?
            </Link>
